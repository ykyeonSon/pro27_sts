...
<body>
	<form method="post"   action="${contextPath}/member/modMember.do?id=${memberVO.id}">
	<h1  class="text_center">회원 정보 수정창6</h1>
	<table  align="center">
	   <tr>
	      <td width="200"><p align="right">아이디</td>
	      <td width="400"><input type="text" name="id" value="${memberVO.id}" disabled="disabled"></td>
	   </tr>
	   <tr>
